...
export function CapabilityCluster({ title, summary, items }: CapabilityClusterProps) {
  return (
    <article
      data-reveal
      className="group rounded-[1.75rem] border border-white/10 bg-white/[0.03] p-6 backdrop-blur-sm transition duration-300 hover:-translate-y-1 hover:border-[color:var(--accent)]/35 hover:bg-white/[0.055] lg:last:col-span-2"
    >
